...
const AboutUs = () => {
    return (
        <section id='aboutUs' className='pt-8'>
            <h1 className='text-7xl text-center my-8 font-semibold'>About Us</h1>
            <div className="aboutUsMainContent flex justify-center items-center">
                <div className="aboutUsPara1 m-4">
                    <h2 className='text-5xl mb-4 bg-red-500 text-white w-fit p-2'>Who We Are</h2>
            ...
            <div className='flex flex-col justify-center items-center py-16'>
                <h2 className='text-5xl mb-4 bg-red-500 text-white w-fit p-2'>Our Products Quality</h2>
