...
const Tshirts = () => {
    ...
    const tshirtsArray = categories.filter((item) => item.category === "shirt");
    ...
    const [likedItems, setLikedItems] = useState(
        tshirtsArray.map(() => false) // Initialize all items as not liked
    );
    ...
    return (
        <>
            ...
            <section id="shop" className="pt-16">
                ...
                <h2 className="text-4xl font-semibold text-center mb-16">Tshirts</h2>
                <div className="allCategories flex w-full flex-wrap justify-center">
                    {tshirtsArray.map((item, index) => (
                        <div
